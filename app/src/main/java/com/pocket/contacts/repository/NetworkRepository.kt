...
object NetworkRepository {
    ...
    suspend fun addContact(contact: Contact):Response<ResponseModel>{
        return RetrofitBuilder.buildService(ApiInterface::class.java).addContact(contact.firstName,contact.middleName,contact.lastName,contact.mobileNo1,contact.mobileNo2,contact.address)
    }
}